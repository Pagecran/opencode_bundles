...
Install-File -RelativeSource "plugins\m365.ts" -RelativeTarget "plugins\m365.ts"
...
Install-DirectoryTree -RelativeSource "runtime" -RelativeTarget "runtime"
Install-DirectoryTree -RelativeSource "methods" -RelativeTarget "methods"
