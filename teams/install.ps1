...
Install-File -RelativeSource "plugins\teams.ts" -RelativeTarget "plugins\teams.ts"
Install-File -RelativeSource "bin\pagecran_teams_cli.mjs" -RelativeTarget "bin\pagecran_teams_cli.mjs"
Install-File -RelativeSource "tsconfig.json" -RelativeTarget "tsconfig.json"

Install-DirectoryTree -RelativeSource "skills\pagecran-teams-auth" -RelativeTarget "skills\pagecran-teams-auth"
Install-DirectoryTree -RelativeSource "skills\pagecran-teams-chat" -RelativeTarget "skills\pagecran-teams-chat"
Install-DirectoryTree -RelativeSource "skills\pagecran-teams-channels" -RelativeTarget "skills\pagecran-teams-channels"
...
Write-Host "Pagecran Teams bundle installed to $ConfigRoot"
