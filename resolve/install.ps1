...
Install-DirectoryTree -RelativeSource "plugins" -RelativeTarget "bundles\resolve\plugins"
Install-DirectoryTree -RelativeSource "runtime" -RelativeTarget "bundles\resolve\runtime"
Install-DirectoryTree -RelativeSource "_runtime" -RelativeTarget "bundles\resolve\_runtime"
Install-DirectoryTree -RelativeSource "methods" -RelativeTarget "bundles\resolve\methods"
Install-DirectoryTree -RelativeSource "scripts" -RelativeTarget "bundles\resolve\scripts"
Install-PluginShim -PluginName "resolve" -BundleName "resolve"
Write-GlobalTsConfig

Install-File -RelativeSource "bin\pagecran_resolve_cli.py" -RelativeTarget "bin\pagecran_resolve_cli.py"
Install-DirectoryTree -RelativeSource "skills\pagecran-resolve-fusion" -RelativeTarget "skills\pagecran-resolve-fusion"
...
Write-Host "Pagecran Resolve bundle installed to $ConfigRoot"
